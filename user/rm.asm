...
main(int argc, char *argv[])
{
  ...
  4c:	7e058593          	addi	a1,a1,2016 # 828 <malloc+0xfe>
  50:	4509                	li	a0,2
  52:	00000097          	auipc	ra,0x0
  56:	5ee080e7          	jalr	1518(ra) # 640 <fprintf>
    exit(1);
  5a:	4505                	li	a0,1
  ...
  6a:	7da58593          	addi	a1,a1,2010 # 840 <malloc+0x116>
  6e:	4509                	li	a0,2
  70:	00000097          	auipc	ra,0x0
  74:	5d0080e7          	jalr	1488(ra) # 640 <fprintf>
      break;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f2:	4d280813          	addi	a6,a6,1234 # 8c0 <digits>
 3f6:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ee:	37e70713          	addi	a4,a4,894 # 868 <malloc+0x13e>
 ...
 57c:	348b8b93          	addi	s7,s7,840 # 8c0 <digits>
 ...
 5d2:	29290913          	addi	s2,s2,658 # 860 <malloc+0x136>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b4:	6107b783          	ld	a5,1552(a5) # cc0 <freep>
 ...
 6c0:	00e6ea63          	bltu	a3,a4,6d4 <free+0x30>
{
 ...
 702:	5cf73123          	sd	a5,1474(a4) # cc0 <freep>
}
 706:	60a2                	ld	ra,8(sp)
 708:	6402                	ld	s0,0(sp)
...
malloc(uint nbytes)
{
 ...
 778:	54c48493          	addi	s1,s1,1356 # cc0 <freep>
  if(p == (char*)-1)
 77c:	5afd                	li	s5,-1
 ...
 78c:	54078793          	addi	a5,a5,1344 # cc8 <base>
 790:	00000717          	auipc	a4,0x0
 794:	52f73823          	sd	a5,1328(a4) # cc0 <freep>
 798:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 806:	4aa73f23          	sd	a0,1214(a4) # cc0 <freep>
      return (void*)(p + 1);
