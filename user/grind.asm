 ...
 */
    ...
    x = (*ctx % 0x7ffffffe) + 1;
      ...
      12:	0705                	addi	a4,a4,1 # ffffffffc0000001 <__global_pointer$+0xffffffffbfffdb8d>
    ...
    lo = x % 127773;
      ...
      30:	b7968693          	addi	a3,a3,-1159 # 1fe3fb79 <__global_pointer$+0x1fe3d705>
      34:	41a70737          	lui	a4,0x41a70
      38:	5af70713          	addi	a4,a4,1455 # 41a705af <__global_pointer$+0x41a6e13b>
      ...
      4c:	66fd                	lui	a3,0x1f
      4e:	31d68693          	addi	a3,a3,797 # 1f31d <__global_pointer$+0x1cea9>
      52:	02d706b3          	mul	a3,a4,a3
      56:	8f95                	sub	a5,a5,a3
    x = 16807 * lo - 2836 * hi;
      58:	6691                	lui	a3,0x4
      5a:	1a768693          	addi	a3,a3,423 # 41a7 <__global_pointer$+0x1d33>
      5e:	02d787b3          	mul	a5,a5,a3
      62:	76fd                	lui	a3,0xfffff
      64:	4ec68693          	addi	a3,a3,1260 # fffffffffffff4ec <__global_pointer$+0xffffffffffffd078>
...
rand(void)
{
    ...
    return (do_rand(&rand_next));
      ...
      9a:	be250513          	addi	a0,a0,-1054 # 1c78 <rand_next>
...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      cc:	32050513          	addi	a0,a0,800 # 13e8 <malloc+0xfc>
      d0:	00001097          	auipc	ra,0x1
      d4:	e62080e7          	jalr	-414(ra) # f32 <mkdir>
  if(chdir("grindir") != 0){
      d8:	00001517          	auipc	a0,0x1
      dc:	31050513          	addi	a0,a0,784 # 13e8 <malloc+0xfc>
    ...
    printf("grind: chdir grindir failed\n");
     ...
     102:	2f250513          	addi	a0,a0,754 # 13f0 <malloc+0x104>
     106:	00001097          	auipc	ra,0x1
     10a:	12a080e7          	jalr	298(ra) # 1230 <printf>
    exit(1);
     10e:	4505                	li	a0,1
  ...
  chdir("/");
     ...
     130:	2ec50513          	addi	a0,a0,748 # 1418 <malloc+0x12c>
     134:	00001097          	auipc	ra,0x1
     138:	e06080e7          	jalr	-506(ra) # f3a <chdir>
     13c:	00001c17          	auipc	s8,0x1
     140:	2ecc0c13          	addi	s8,s8,748 # 1428 <malloc+0x13c>
     144:	c489                	beqz	s1,14e <go+0xa0>
     146:	00001c17          	auipc	s8,0x1
     14a:	2dac0c13          	addi	s8,s8,730 # 1420 <malloc+0x134>
  uint64 iters = 0;
     14e:	4481                	li	s1,0
  int fd = -1;
     150:	5cfd                	li	s9,-1
  ...
  while(1){
    ...
    if((iters % 500) == 0)
     ...
     156:	dd398993          	addi	s3,s3,-557 # 10624dd3 <__global_pointer$+0x1062295f>
    ...
    int what = rand() % 23;
     ...
     174:	2c9a8a93          	addi	s5,s5,713 # ffffffffb21642c9 <__global_pointer$+0xffffffffb2161e55>
     178:	4b59                	li	s6,22
     17a:	00001917          	auipc	s2,0x1
     17e:	57e90913          	addi	s2,s2,1406 # 16f8 <malloc+0x40c>
      close(fd1);
      unlink("c");
    } else if(what == 22){
      // echo hi | cat
     ...
     190:	2a450513          	addi	a0,a0,676 # 1430 <malloc+0x144>
    ...
    int what = rand() % 23;
     ...
     20c:	23850513          	addi	a0,a0,568 # 1440 <malloc+0x154>
     ...
     294:	1d050513          	addi	a0,a0,464 # 1460 <malloc+0x174>
     ...
     2b6:	1be50513          	addi	a0,a0,446 # 1470 <malloc+0x184>
     ...
     2ce:	9be58593          	addi	a1,a1,-1602 # 1c88 <buf.0>
     2d2:	8566                	mv	a0,s9
     ...
     2e6:	9a658593          	addi	a1,a1,-1626 # 1c88 <buf.0>
     2ea:	8566                	mv	a0,s9
     ...
     3ec:	11050513          	addi	a0,a0,272 # 14f8 <malloc+0x20c>
     3f0:	00001097          	auipc	ra,0x1
     3f4:	e40080e7          	jalr	-448(ra) # 1230 <printf>
        exit(1);
     3f8:	4505                	li	a0,1
     ...
     43a:	0c250513          	addi	a0,a0,194 # 14f8 <malloc+0x20c>
     43e:	00001097          	auipc	ra,0x1
     442:	df2080e7          	jalr	-526(ra) # 1230 <printf>
        exit(1);
     446:	4505                	li	a0,1
     ...
     44c:	a82080e7          	jalr	-1406(ra) # eca <exit>
      sbrk(6011);
     450:	6505                	lui	a0,0x1
     452:	77b50513          	addi	a0,a0,1915 # 177b <malloc+0x48f>
     ...
     4a2:	07a50513          	addi	a0,a0,122 # 1518 <malloc+0x22c>
     ...
     4ce:	04650513          	addi	a0,a0,70 # 1510 <malloc+0x224>
     ...
     4f0:	00c50513          	addi	a0,a0,12 # 14f8 <malloc+0x20c>
     4f4:	00001097          	auipc	ra,0x1
     4f8:	d3c080e7          	jalr	-708(ra) # 1230 <printf>
        exit(1);
     4fc:	4505                	li	a0,1
     ...
     50a:	02250513          	addi	a0,a0,34 # 1528 <malloc+0x23c>
     50e:	00001097          	auipc	ra,0x1
     512:	d22080e7          	jalr	-734(ra) # 1230 <printf>
        exit(1);
     516:	4505                	li	a0,1
     ...
     558:	fa450513          	addi	a0,a0,-92 # 14f8 <malloc+0x20c>
     55c:	00001097          	auipc	ra,0x1
     560:	cd4080e7          	jalr	-812(ra) # 1230 <printf>
        exit(1);
     564:	4505                	li	a0,1
     ...
     5b4:	f9050513          	addi	a0,a0,-112 # 1540 <malloc+0x254>
     5b8:	00001097          	auipc	ra,0x1
     5bc:	c78080e7          	jalr	-904(ra) # 1230 <printf>
        exit(1);
     5c0:	4505                	li	a0,1
     ...
     5e0:	f7c58593          	addi	a1,a1,-132 # 1558 <malloc+0x26c>
     ...
     61c:	f4850513          	addi	a0,a0,-184 # 1560 <malloc+0x274>
     620:	00001097          	auipc	ra,0x1
     624:	c10080e7          	jalr	-1008(ra) # 1230 <printf>
     628:	b7f9                	j	5f6 <go+0x548>
          printf("grind: pipe read failed\n");
     62a:	00001517          	auipc	a0,0x1
     62e:	f5650513          	addi	a0,a0,-170 # 1580 <malloc+0x294>
     632:	00001097          	auipc	ra,0x1
     636:	bfe080e7          	jalr	-1026(ra) # 1230 <printf>
     63a:	bfd1                	j	60e <go+0x560>
        printf("grind: fork failed\n");
     63c:	00001517          	auipc	a0,0x1
     640:	ebc50513          	addi	a0,a0,-324 # 14f8 <malloc+0x20c>
     644:	00001097          	auipc	ra,0x1
     648:	bec080e7          	jalr	-1044(ra) # 1230 <printf>
        exit(1);
     64c:	4505                	li	a0,1
     ...
     6e2:	e1a50513          	addi	a0,a0,-486 # 14f8 <malloc+0x20c>
     6e6:	00001097          	auipc	ra,0x1
     6ea:	b4a080e7          	jalr	-1206(ra) # 1230 <printf>
        exit(1);
     6ee:	4505                	li	a0,1
     ...
     728:	e3458593          	addi	a1,a1,-460 # 1558 <malloc+0x26c>
     ...
     76a:	e4250513          	addi	a0,a0,-446 # 15a8 <malloc+0x2bc>
     76e:	00000097          	auipc	ra,0x0
     772:	7ac080e7          	jalr	1964(ra) # f1a <unlink>
     776:	b43d                	j	1a4 <go+0xf6>
        printf("grind: create c failed\n");
     778:	00001517          	auipc	a0,0x1
     77c:	e3850513          	addi	a0,a0,-456 # 15b0 <malloc+0x2c4>
     780:	00001097          	auipc	ra,0x1
     784:	ab0080e7          	jalr	-1360(ra) # 1230 <printf>
        exit(1);
     788:	4505                	li	a0,1
     ...
     796:	e3650513          	addi	a0,a0,-458 # 15c8 <malloc+0x2dc>
     79a:	00001097          	auipc	ra,0x1
     79e:	a96080e7          	jalr	-1386(ra) # 1230 <printf>
        exit(1);
     7a2:	4505                	li	a0,1
     ...
     7b0:	e3450513          	addi	a0,a0,-460 # 15e0 <malloc+0x2f4>
     7b4:	00001097          	auipc	ra,0x1
     7b8:	a7c080e7          	jalr	-1412(ra) # 1230 <printf>
        exit(1);
     7bc:	4505                	li	a0,1
     ...
     7cc:	e3050513          	addi	a0,a0,-464 # 15f8 <malloc+0x30c>
     7d0:	00001097          	auipc	ra,0x1
     7d4:	a60080e7          	jalr	-1440(ra) # 1230 <printf>
        exit(1);
     7d8:	4505                	li	a0,1
     ...
     7e6:	e3e50513          	addi	a0,a0,-450 # 1620 <malloc+0x334>
     7ea:	00001097          	auipc	ra,0x1
     7ee:	a46080e7          	jalr	-1466(ra) # 1230 <printf>
        exit(1);
     7f2:	4505                	li	a0,1
     ...
     8cc:	df858593          	addi	a1,a1,-520 # 16c0 <malloc+0x3d4>
     ...
     8f0:	ddc50513          	addi	a0,a0,-548 # 16c8 <malloc+0x3dc>
     8f4:	00001097          	auipc	ra,0x1
     8f8:	93c080e7          	jalr	-1732(ra) # 1230 <printf>
        exit(1);
     8fc:	4505                	li	a0,1
     ...
     90a:	c3a58593          	addi	a1,a1,-966 # 1540 <malloc+0x254>
     90e:	4509                	li	a0,2
     910:	00001097          	auipc	ra,0x1
     914:	8f2080e7          	jalr	-1806(ra) # 1202 <fprintf>
        exit(1);
     918:	4505                	li	a0,1
     ...
     926:	c1e58593          	addi	a1,a1,-994 # 1540 <malloc+0x254>
     92a:	4509                	li	a0,2
     92c:	00001097          	auipc	ra,0x1
     930:	8d6080e7          	jalr	-1834(ra) # 1202 <fprintf>
        exit(1);
     934:	4505                	li	a0,1
     ...
     982:	cca58593          	addi	a1,a1,-822 # 1648 <malloc+0x35c>
     986:	4509                	li	a0,2
     988:	00001097          	auipc	ra,0x1
     98c:	87a080e7          	jalr	-1926(ra) # 1202 <fprintf>
          exit(1);
     990:	4505                	li	a0,1
     ...
     9f6:	b0658593          	addi	a1,a1,-1274 # 14f8 <malloc+0x20c>
     9fa:	4509                	li	a0,2
     9fc:	00001097          	auipc	ra,0x1
     a00:	806080e7          	jalr	-2042(ra) # 1202 <fprintf>
        exit(3);
     a04:	450d                	li	a0,3
     ...
     a42:	c0a58593          	addi	a1,a1,-1014 # 1648 <malloc+0x35c>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	7ba080e7          	jalr	1978(ra) # 1202 <fprintf>
          exit(4);
     a50:	4511                	li	a0,4
     ...
     a86:	bc658593          	addi	a1,a1,-1082 # 1648 <malloc+0x35c>
     a8a:	4509                	li	a0,2
     a8c:	00000097          	auipc	ra,0x0
     a90:	776080e7          	jalr	1910(ra) # 1202 <fprintf>
          exit(5);
     a94:	4515                	li	a0,5
     ...
     aae:	bee78793          	addi	a5,a5,-1042 # 1698 <malloc+0x3ac>
     ab2:	f6f43c23          	sd	a5,-136(s0)
     ab6:	f8043023          	sd	zero,-128(s0)
        exec("/cat", args);
     aba:	f7840593          	addi	a1,s0,-136
     abe:	00001517          	auipc	a0,0x1
     ac2:	be250513          	addi	a0,a0,-1054 # 16a0 <malloc+0x3b4>
     ac6:	00000097          	auipc	ra,0x0
     aca:	43c080e7          	jalr	1084(ra) # f02 <exec>
        fprintf(2, "grind: cat: not found\n");
     ace:	00001597          	auipc	a1,0x1
     ad2:	bda58593          	addi	a1,a1,-1062 # 16a8 <malloc+0x3bc>
     ad6:	4509                	li	a0,2
     ad8:	00000097          	auipc	ra,0x0
     adc:	72a080e7          	jalr	1834(ra) # 1202 <fprintf>
        exit(6);
     ae0:	4519                	li	a0,6
     ...
     aee:	a0e58593          	addi	a1,a1,-1522 # 14f8 <malloc+0x20c>
     af2:	4509                	li	a0,2
     af4:	00000097          	auipc	ra,0x0
     af8:	70e080e7          	jalr	1806(ra) # 1202 <fprintf>
        exit(7);
     afc:	451d                	li	a0,7
...
iter()
{
  ...
  unlink("a");
     ...
     b12:	a0250513          	addi	a0,a0,-1534 # 1510 <malloc+0x224>
     b16:	00000097          	auipc	ra,0x0
     b1a:	404080e7          	jalr	1028(ra) # f1a <unlink>
  unlink("b");
     b1e:	00001517          	auipc	a0,0x1
     b22:	9a250513          	addi	a0,a0,-1630 # 14c0 <malloc+0x1d4>
  ...
  if(pid1 == 0){
    ...
    rand_next = 31;
     ...
     b48:	12f73a23          	sd	a5,308(a4) # 1c78 <rand_next>
    go(0);
     b4c:	4501                	li	a0,0
    ...
    printf("grind: fork failed\n");
     ...
     b5e:	99e50513          	addi	a0,a0,-1634 # 14f8 <malloc+0x20c>
     b62:	00000097          	auipc	ra,0x0
     b66:	6ce080e7          	jalr	1742(ra) # 1230 <printf>
    exit(1);
     b6a:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     b86:	6789                	lui	a5,0x2
     b88:	c0978793          	addi	a5,a5,-1015 # 1c09 <digits+0x459>
     b8c:	00001717          	auipc	a4,0x1
     b90:	0ef73623          	sd	a5,236(a4) # 1c78 <rand_next>
    go(1);
     b94:	4505                	li	a0,1
    ...
    printf("grind: fork failed\n");
     ...
     ba2:	95a50513          	addi	a0,a0,-1702 # 14f8 <malloc+0x20c>
     ba6:	00000097          	auipc	ra,0x0
     baa:	68a080e7          	jalr	1674(ra) # 1230 <printf>
    exit(1);
     bae:	4505                	li	a0,1
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     f80:	f6e080e7          	jalr	-146(ra) # eea <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
     ...
     f92:	f04a                	sd	s2,32(sp)
     f94:	ec4e                	sd	s3,24(sp)
     f96:	0080                	addi	s0,sp,64
     f98:	892a                	mv	s2,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
     f9a:	cad9                	beqz	a3,1030 <printint+0xa4>
     f9c:	01f5d79b          	srliw	a5,a1,0x1f
     fa0:	cbc1                	beqz	a5,1030 <printint+0xa4>
    neg = 1;
    x = -xx;
  ...
  do{
    buf[i++] = digits[x % base];
     fb0:	00001817          	auipc	a6,0x1
     fb4:	80080813          	addi	a6,a6,-2048 # 17b0 <digits>
     fb8:	88ba                	mv	a7,a4
     fba:	0017051b          	addiw	a0,a4,1
     fbe:	872a                	mv	a4,a0
     fc0:	02c5f7bb          	remuw	a5,a1,a2
     fc4:	1782                	slli	a5,a5,0x20
     fc6:	9381                	srli	a5,a5,0x20
     fc8:	97c2                	add	a5,a5,a6
     ...
     fda:	fcc7ffe3          	bgeu	a5,a2,fb8 <printint+0x2c>
  if(neg)
     fde:	00030c63          	beqz	t1,ff6 <printint+0x6a>
    buf[i++] = '-';
     fe2:	fd050793          	addi	a5,a0,-48
     fe6:	00878533          	add	a0,a5,s0
     fea:	02d00793          	li	a5,45
     fee:	fef50823          	sb	a5,-16(a0)
     ff2:	0028871b          	addiw	a4,a7,2

  while(--i >= 0)
     ff6:	02e05763          	blez	a4,1024 <printint+0x98>
     ffa:	f426                	sd	s1,40(sp)
     ffc:	377d                	addiw	a4,a4,-1
     ffe:	00e984b3          	add	s1,s3,a4
    1002:	19fd                	addi	s3,s3,-1
  ...
  while(--i >= 0)
    101c:	14fd                	addi	s1,s1,-1
    101e:	ff3498e3          	bne	s1,s3,100e <printint+0x82>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1042:	1a090b63          	beqz	s2,11f8 <vprintf+0x1c4>
  ...
  state = 0;
    ...
    106c:	f02080e7          	jalr	-254(ra) # f6a <putc>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    107c:	16090863          	beqz	s2,11ec <vprintf+0x1b8>
    if(state == 0){
    ...
    108a:	b7f5                	j	1076 <vprintf+0x42>
      if(c == 'd'){
    108c:	13490563          	beq	s2,s4,11b6 <vprintf+0x182>
    1090:	f9d9079b          	addiw	a5,s2,-99
    1094:	0ff7f793          	zext.b	a5,a5
    1098:	12fb6863          	bltu	s6,a5,11c8 <vprintf+0x194>
    109c:	f9d9079b          	addiw	a5,s2,-99
    10a0:	0ff7f713          	zext.b	a4,a5
    10a4:	12eb6263          	bltu	s6,a4,11c8 <vprintf+0x194>
    10a8:	00271793          	slli	a5,a4,0x2
    10ac:	00000717          	auipc	a4,0x0
    10b0:	6ac70713          	addi	a4,a4,1708 # 1758 <malloc+0x46c>
    ...
    10ce:	ec2080e7          	jalr	-318(ra) # f8c <printint>
    10d2:	8bca                	mv	s7,s2
      } else {
    ...
    10ea:	ea6080e7          	jalr	-346(ra) # f8c <printint>
    10ee:	8bca                	mv	s7,s2
      state = 0;
    10f0:	4981                	li	s3,0
    ...
    1106:	e8a080e7          	jalr	-374(ra) # f8c <printint>
    110a:	8bca                	mv	s7,s2
      state = 0;
    110c:	4981                	li	s3,0
    ...
    1112:	008b8793          	addi	a5,s7,8
    1116:	8c3e                	mv	s8,a5
    1118:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    111c:	03000593          	li	a1,48
    1120:	8556                	mv	a0,s5
    1122:	00000097          	auipc	ra,0x0
    1126:	e48080e7          	jalr	-440(ra) # f6a <putc>
  putc(fd, 'x');
    112a:	07800593          	li	a1,120
    112e:	8556                	mv	a0,s5
    1130:	00000097          	auipc	ra,0x0
    1134:	e3a080e7          	jalr	-454(ra) # f6a <putc>
    1138:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    113a:	00000b97          	auipc	s7,0x0
    113e:	676b8b93          	addi	s7,s7,1654 # 17b0 <digits>
    1142:	03c9d793          	srli	a5,s3,0x3c
    1146:	97de                	add	a5,a5,s7
    1148:	0007c583          	lbu	a1,0(a5)
    114c:	8556                	mv	a0,s5
    114e:	00000097          	auipc	ra,0x0
    1152:	e1c080e7          	jalr	-484(ra) # f6a <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1156:	0992                	slli	s3,s3,0x4
    1158:	397d                	addiw	s2,s2,-1
    115a:	fe0914e3          	bnez	s2,1142 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
    115e:	8be2                	mv	s7,s8
      state = 0;
    1160:	4981                	li	s3,0
    1162:	6c02                	ld	s8,0(sp)
    1164:	bf09                	j	1076 <vprintf+0x42>
        s = va_arg(ap, char*);
    1166:	008b8993          	addi	s3,s7,8
    116a:	000bb903          	ld	s2,0(s7)
        if(s == 0)
    116e:	02090163          	beqz	s2,1190 <vprintf+0x15c>
        while(*s != 0){
    1172:	00094583          	lbu	a1,0(s2)
    1176:	c9a5                	beqz	a1,11e6 <vprintf+0x1b2>
          putc(fd, *s);
    1178:	8556                	mv	a0,s5
    ...
    1188:	f9e5                	bnez	a1,1178 <vprintf+0x144>
        s = va_arg(ap, char*);
    118a:	8bce                	mv	s7,s3
      state = 0;
    118c:	4981                	li	s3,0
    118e:	b5e5                	j	1076 <vprintf+0x42>
          s = "(null)";
    1190:	00000917          	auipc	s2,0x0
    1194:	56090913          	addi	s2,s2,1376 # 16f0 <malloc+0x404>
        while(*s != 0){
    1198:	02800593          	li	a1,40
    119c:	bff1                	j	1178 <vprintf+0x144>
    ...
    11de:	d90080e7          	jalr	-624(ra) # f6a <putc>
      state = 0;
    11e2:	4981                	li	s3,0
    11e4:	bd49                	j	1076 <vprintf+0x42>
        s = va_arg(ap, char*);
    11e6:	8bce                	mv	s7,s3
      state = 0;
    11e8:	4981                	li	s3,0
    11ea:	b571                	j	1076 <vprintf+0x42>
    11ec:	74e2                	ld	s1,56(sp)
    11ee:	79a2                	ld	s3,40(sp)
    11f0:	7a02                	ld	s4,32(sp)
    11f2:	6ae2                	ld	s5,24(sp)
    11f4:	6b42                	ld	s6,16(sp)
    11f6:	6ba2                	ld	s7,8(sp)
    }
  }
}
    11f8:	60a6                	ld	ra,72(sp)
    11fa:	6406                	ld	s0,64(sp)
    11fc:	7942                	ld	s2,48(sp)
    11fe:	6161                	addi	sp,sp,80
    1200:	8082                	ret

0000000000001202 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    1202:	715d                	addi	sp,sp,-80
    1204:	ec06                	sd	ra,24(sp)
    1206:	e822                	sd	s0,16(sp)
    1208:	1000                	addi	s0,sp,32
    120a:	e010                	sd	a2,0(s0)
    120c:	e414                	sd	a3,8(s0)
    120e:	e818                	sd	a4,16(s0)
    1210:	ec1c                	sd	a5,24(s0)
    1212:	03043023          	sd	a6,32(s0)
    1216:	03143423          	sd	a7,40(s0)
  va_list ap;
  ...
  vprintf(fd, fmt, ap);
    ...
    1224:	e14080e7          	jalr	-492(ra) # 1034 <vprintf>
}
    1228:	60e2                	ld	ra,24(sp)
    122a:	6442                	ld	s0,16(sp)
    122c:	6161                	addi	sp,sp,80
    122e:	8082                	ret

0000000000001230 <printf>:

void
printf(const char *fmt, ...)
{
    1230:	711d                	addi	sp,sp,-96
    1232:	ec06                	sd	ra,24(sp)
    1234:	e822                	sd	s0,16(sp)
    1236:	1000                	addi	s0,sp,32
    1238:	e40c                	sd	a1,8(s0)
    123a:	e810                	sd	a2,16(s0)
    123c:	ec14                	sd	a3,24(s0)
    123e:	f018                	sd	a4,32(s0)
    1240:	f41c                	sd	a5,40(s0)
    1242:	03043823          	sd	a6,48(s0)
    1246:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    124a:	00840613          	addi	a2,s0,8
    124e:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    1252:	85aa                	mv	a1,a0
    1254:	4505                	li	a0,1
    1256:	00000097          	auipc	ra,0x0
    125a:	dde080e7          	jalr	-546(ra) # 1034 <vprintf>
}
    125e:	60e2                	ld	ra,24(sp)
    1260:	6442                	ld	s0,16(sp)
    1262:	6125                	addi	sp,sp,96
    1264:	8082                	ret

0000000000001266 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1276:	a0e7b783          	ld	a5,-1522(a5) # 1c80 <freep>
    127a:	a039                	j	1288 <free+0x22>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    127c:	6398                	ld	a4,0(a5)
    127e:	00e7e463          	bltu	a5,a4,1286 <free+0x20>
    1282:	00e6ea63          	bltu	a3,a4,1296 <free+0x30>
{
    1286:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1288:	fed7fae3          	bgeu	a5,a3,127c <free+0x16>
    128c:	6398                	ld	a4,0(a5)
    128e:	00e6e463          	bltu	a3,a4,1296 <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1292:	fee7eae3          	bltu	a5,a4,1286 <free+0x20>
      break;
  if(bp + bp->s.size == p->s.ptr){
    ...
    12a6:	02e60563          	beq	a2,a4,12d0 <free+0x6a>
  ...
  if(p + p->s.size == bp){
    ...
    12ba:	02e68263          	beq	a3,a4,12de <free+0x78>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  ...
  freep = p;
    ...
    12c4:	9cf73023          	sd	a5,-1600(a4) # 1c80 <freep>
}
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    12f8:	02051993          	slli	s3,a0,0x20
    12fc:	0209d993          	srli	s3,s3,0x20
    1300:	09bd                	addi	s3,s3,15
    1302:	0049d993          	srli	s3,s3,0x4
    1306:	2985                	addiw	s3,s3,1
    1308:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    130a:	00001517          	auipc	a0,0x1
    130e:	97653503          	ld	a0,-1674(a0) # 1c80 <freep>
    1312:	c905                	beqz	a0,1342 <malloc+0x56>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1318:	09377a63          	bgeu	a4,s3,13ac <malloc+0xc0>
  ...
  if(nu < 4096)
    ...
    1328:	00e9f363          	bgeu	s3,a4,132e <malloc+0x42>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    1336:	00001497          	auipc	s1,0x1
    133a:	94a48493          	addi	s1,s1,-1718 # 1c80 <freep>
  if(p == (char*)-1)
    133e:	5afd                	li	s5,-1
    1340:	a089                	j	1382 <malloc+0x96>
    ...
    134e:	d2678793          	addi	a5,a5,-730 # 2070 <base>
    1352:	00001717          	auipc	a4,0x1
    1356:	92f73723          	sd	a5,-1746(a4) # 1c80 <freep>
    135a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    135c:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    1360:	b7d1                	j	1324 <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
    1362:	6398                	ld	a4,0(a5)
    1364:	e118                	sd	a4,0(a0)
    1366:	a8b9                	j	13c4 <malloc+0xd8>
  hp->s.size = nu;
    1368:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    136c:	0541                	addi	a0,a0,16
    136e:	00000097          	auipc	ra,0x0
    1372:	ef8080e7          	jalr	-264(ra) # 1266 <free>
  return freep;
    1376:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    1378:	c135                	beqz	a0,13dc <malloc+0xf0>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    137a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    137c:	4798                	lw	a4,8(a5)
    137e:	03277363          	bgeu	a4,s2,13a4 <malloc+0xb8>
    if(p == freep)
    1382:	6098                	ld	a4,0(s1)
    1384:	853e                	mv	a0,a5
    1386:	fef71ae3          	bne	a4,a5,137a <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    138a:	8552                	mv	a0,s4
    138c:	00000097          	auipc	ra,0x0
    1390:	bc6080e7          	jalr	-1082(ra) # f52 <sbrk>
  if(p == (char*)-1)
    1394:	fd551ae3          	bne	a0,s5,1368 <malloc+0x7c>
        return 0;
    1398:	4501                	li	a0,0
    ...
    13a2:	a03d                	j	13d0 <malloc+0xe4>
    13a4:	74a2                	ld	s1,40(sp)
    13a6:	6a42                	ld	s4,16(sp)
    13a8:	6aa2                	ld	s5,8(sp)
    13aa:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    13ac:	fae90be3          	beq	s2,a4,1362 <malloc+0x76>
        p->s.size -= nunits;
    ...
    13c8:	8aa73e23          	sd	a0,-1860(a4) # 1c80 <freep>
      return (void*)(p + 1);
    ...
    13d4:	7902                	ld	s2,32(sp)
    13d6:	69e2                	ld	s3,24(sp)
    13d8:	6121                	addi	sp,sp,64
    13da:	8082                	ret
    13dc:	74a2                	ld	s1,40(sp)
    13de:	6a42                	ld	s4,16(sp)
    13e0:	6aa2                	ld	s5,8(sp)
    13e2:	6b02                	ld	s6,0(sp)
    13e4:	b7f5                	j	13d0 <malloc+0xe4>
